...
export const services = [
  ...
  },
  {
    id: "consultation",
    icon: MessageSquare,
    title: "פגישות יעוץ / חוות דעת מקצועית",
    ...
    sections: [
      {
        ...
        extendedDescription: [
          "🏘️ שוקלים לקנות דירה חדשה מקבלן אבל לא בטוחים אם השינויים אפשריים?",
          "🛠️ רוצים לבצע שינוי בנכס קיים אך מתלבטים אם הוא ישים?",
          "📄 צריכים חוות דעת על תוכנית קיימת או פשוט רוצים חוות דעת נוספת?",
          "✅ צריכים מישהו אובייקטיבי שייתן חוות דעת ללא אינטרסים?",
          "תוכנית בקליק כאן בשבילכם – בלי תיווך ובלי עלויות מיותרות.",
          "פשוט, מקצועי ומהיר."
        ],
        process: [
          "📌 מעלים את התוכנית המתאימה והשאלות,",
          "📝 מקבלים חוות דעת מקצועית עם תשובות, הסברים ברורים ופירוט."
        ]
      },
      {
        title: "פגישת ייעוץ",
        extendedDescription: [
          "❓ מתלבטים? יש לכם שאלות?",
          "💡 צריכים עזרה בפיתוח רעיון או בבדיקת היתכנות לפני שמתקדמים?",
          "🖊️ רוצים להבין איך אפשר לשפר תוכנית קיימת או לגבש כיוון ברור לפני שרטוט?",
          "תוכנית בקליק כאן בשבילכם – בלי תיווך ובלי עלויות מיותרות.",
          "פשוט, מדויק, ומהיר."
        ],
        process: [
          "📌 מעלים מראש תוכנית או סקיצה עם רעיונות / שאלות שלכם,",
          "🗓️ קובעים פגישת ייעוץ דיגיטלית עם מתכנן או מעצב מקצועי ומקבלים את כל התשובות כולל יעוץ והכוונה מקצועית."
        ]
      }
    ],
    notes: [
      "שירות חוות הדעת אינו כולל יעוץ, שרטוט, תכנון ופגישות.",
      "שירות היעוץ אינו כולל, שרטוט תכנון או עיצוב פנים.",
      "יעוץ / חוות דעת זו אינה מחליפה חוות דעת יועצים מקצועיים.",
      "יש לאשר כל תוכנית מול יועץ מקצועי טרם ביצוע."
    ]
  },
  {
    id: "full-planning",
    ...
    extendedDescription: [
      ...
      "לא רוצים להסתבך ומעדיפים תכנון כולל וליווי אישי של מעצב/ת – משלב הרעיון ועד לגימור הסופי?",
      "תוכנית בקליק כאן בשבילכם – בלי תיווך ובלי עלויות מיותרות."
    ],
    includedServices: [
      "📌 פגישות פרונטליות ודיגיטליות.",
      "📄 הכנת תוכניות ביצוע ועיצוב פנים.",
      "🎨 ליווי בבחירת פרטי הגמר.",
      "🪚 תכנון פרטי גבס ונגרות.",
      "והכול כחלק מחבילה אחת מושלמת, בליווי אישי עד סיום הפרויקט."
    ],
    notes: [
      "השירות אינו כולל הגשת תוכניות לרשויות ו/או חתימה ו/או ליווי להיתרים.",
      "יש להעביר את התוכניות ליועצים מקצועיים לאישור טרם ביצוע התוכנית.",
      "הצעת מחיר לשירות זה תינתן ע\"פ היקף הפרויקט והצרכים הספציפיים לפרויקט. יש לפנות דרך צור קשר ואנו נחזור אליכם להמשך התהליך."
    ]
  }
];
